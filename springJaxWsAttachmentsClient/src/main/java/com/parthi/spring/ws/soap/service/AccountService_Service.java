 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://service.soap.ws.spring.parthi.com/", wsdlLocation = "file:/G:/codebase/soapRest/springJaxWsAttachmentsClient/src/main/resources/getAccountDetails.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/G:/codebase/soapRest/springJaxWsAttachmentsClient/src/main/resources/getAccountDetails.wsdl");
