 ...
 * 
 */
@WebServiceClient(name = "accountService", targetNamespace = "http://service.soap.ws.spring.parthi.com/", wsdlLocation = "file:/G:/codebase/soapRest/springSoapWsSecurityClient/src/main/resources/accountService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/G:/codebase/soapRest/springSoapWsSecurityClient/src/main/resources/accountService.wsdl");
